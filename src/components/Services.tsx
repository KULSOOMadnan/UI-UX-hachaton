...
// function Services() {
//   return (
//     <div className='h-[40vh] bg-[#FAF3EA] grid lg:grid-cols-4  py-[100px] justify-center items-center px-16'>
//         <div className='col-span-1 flex gap-4'>
//          <Image src={trophy} width={60} height={50} alt='trophy'/>
//             <div className='flex flex-col gap-2 font-poppins '>
//                 <h1 className='text-[20px] font-semibold text-[#242424]'>High Quality</h1>
//                 <h1 className='text-[16px] font-semibold  text-[#898989]'>crafted from top materials</h1>
//             </div>
//         </div>
//         <div className='col-span-1 flex gap-2'>
//          <Image src={garanty} width={60} height={60} alt='trophy'/>
//             <div className='flex flex-col gap-2 font-poppins '>
//                 <h1 className='text-[20px] font-semibold text-[#242424]'>Waranty Protection</h1>
//                 <h1 className='text-[16px] font-semibold  text-[#898989]'>Over 2 years</h1>
//             </div>
//         </div>
//         <div className='col-span-1 flex gap-2'>
//          <Image src={Ship} width={60} height={60} alt='trophy'/>
//             <div className='flex flex-col gap-2 font-poppins '>
//                 <h1 className='text-[20px] font-semibold text-[#242424]'>Free Shipping</h1>
//                 <h1 className='text-[16px] font-semibold  text-[#898989]'>Order over 150 $</h1>
//             </div>
//         </div>
//         <div className='col-span-1 flex gap-2'>
//          <Image src={customer} width={60} height={60} alt='trophy'/>
//             <div className='flex flex-col gap-2 font-poppins '>
//                 <h1 className='text-[20px] font-semibold text-[#242424]'>24 / 7 Support</h1>
//                 <h1 className='text-[16px] font-semibold  text-[#898989]'>Dedicated Support</h1>
//             </div>
//         </div>
//     </div>
//   )
