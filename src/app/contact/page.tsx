...
//         {/* intro */}
//         <div className="flex justify-center items-center flex-col gap-4 mt-10 py-10">
//           <h1 className="text-[32px] font-poppins text-center font-semibold">
//             {" "}
//             Get In Touch With Us
//           </h1>
//           <p className="text-[#9F9F9F] text-center text-[14px]">
...
//         <div className="grid grid-cols-2 items-center gap-8  px-28 py-16">
//           {/* form side links */}
...
//                 <h1 className="flex-[20px] font-poppins">Address</h1>
...
//               </div>
//               <div className="flex flex-col gap-3">
//                 <h1 className="flex-[20px] font-poppins">Phone</h1>
//                 <p className="text-sm text-[#000000]">
...
//               </div>
//               <div className="flex flex-col gap-3">
//                 <h1 className="flex-[20px] font-poppins">Working Time</h1>
//                 <p className="text-sm text-[#000000]">
...
//                   className="border-[#9F9F9F] border rounded-md px-9 py-3 text-[16px] w-[400px]"
//                 ></input>
//               </div>
...
//                 ></textarea>
//               </div>
//               <button className="bg-[#B88E2F] w-[230px] text-center text-white rounded font-poppins text-[14px] py-4 hover:bg-[#856620]" >Submit</button>
//             </form>
...
<div className="flex flex-col col-span-1 gap-10 md:items-center">
  {/* Address */}
  <div className="flex gap-5 md:flex-col md:items-center">
    ...
    <div className="flex flex-col gap-3 md:text-center">
      <h1 className="flex-[20px] font-poppins">Address</h1>
      <p className="text-sm text-[#000000]">
        236 5th SE Avenue, New <br /> York NY10000, <br /> United States
      </p>
    </div>
  </div>
